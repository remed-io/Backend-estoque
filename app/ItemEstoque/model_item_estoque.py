...
class ItemEstoque(Base):
    ...
    cuidado_pessoal_id = Column(Integer, ForeignKey('cuidado_pessoal.id'), nullable=True)
    suplemento_alimentar_id = Column(Integer, ForeignKey('suplemento_alimentar.id'), nullable=True)
